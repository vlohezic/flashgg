...
cfgTools.addCategories(process.tthHadronicTagDumper,
			...
			"jet1_bbdiscriminant  := ?(jetVector.size>0)? jetVector.at(0).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
                        ...
                        "jet11_bbdiscriminant  := ?(jetVector.size>10)? jetVector.at(10).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
                        "jet12_bbdiscriminant  := ?(jetVector.size>11)? jetVector.at(11).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
                        "jet13_bbdiscriminant  := ?(jetVector.size>12)? jetVector.at(12).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
                        "jet14_bbdiscriminant  := ?(jetVector.size>13)? jetVector.at(13).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
			...
			"jet1_cdiscriminant  := ?(jetVector.size>0)? jetVector.at(0).bDiscriminator('pfDeepCSVJetTags:probc') : -1",
                        ...
                        "jet11_cdiscriminant  := ?(jetVector.size>10)? jetVector.at(10).bDiscriminator('pfDeepCSVJetTags:probc') : -1",
                        "jet12_cdiscriminant  := ?(jetVector.size>11)? jetVector.at(11).bDiscriminator('pfDeepCSVJetTags:probc') : -1",
                        "jet13_cdiscriminant  := ?(jetVector.size>12)? jetVector.at(12).bDiscriminator('pfDeepCSVJetTags:probc') : -1",
                        "jet14_cdiscriminant  := ?(jetVector.size>13)? jetVector.at(13).bDiscriminator('pfDeepCSVJetTags:probc') : -1",
