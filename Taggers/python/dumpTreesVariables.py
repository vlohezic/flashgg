...
ttHLeptonic_variables = ["diPhoBDT              := diPhoBDT",
                         "tthVSttggDNN          := tthVSttggDNN",
                         "tthVSthDNN            := tthVSthDNN",
                         "tthBDT                := tthBDT",
                         ...
                         "topTagger_score       := topTagger.at(0)",
                         "topTagger_topPt       := topTagger.at(1)",
                         "topTagger_topEta      := topTagger.at(2)",
                         "topTagger_topPhi      := topTagger.at(3)",
                         "topTagger_topMass     := topTagger.at(4)",
                         "topTagger_WPt         := topTagger.at(5)",
                         "topTagger_WEta        := topTagger.at(6)",
                         "topTagger_WPhi        := topTagger.at(7)",
                         "topTagger_WMass       := topTagger.at(8)"
                         #"topMt                := gettop_mt()",
...
ttHHadronic_variables = [ "tthVSdiPhoDNN         := tthVSdiPhoDNN",
                          "tthVSttggDNN          := tthVSttggDNN",
                          "tthBDT                := tthBDT",
                          "diPhoHelicity         := diPhoHelicity",
                          "nJets                 := nJet",
                          ...
                          "btag_7                := ?(jetVector.size>6)? jetVector.at(6).bDiscriminator('pfDeepCSVJetTags:probb')+jetVector.at(6).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
                          ...
                          "btag_8                := ?(jetVector.size>7)? jetVector.at(7).bDiscriminator('pfDeepCSVJetTags:probb')+jetVector.at(7).bDiscriminator('pfDeepCSVJetTags:probbb') : -1",
