...
#JM define my variables:
from flashgg.Taggers.dumpTreesVariables import dipho_variables,weight_variables,ttHLeptonic_variables,ttHHadronic_variables
...
customize.options.register('doSystematics',
                           False, # JM set to false for ntupling
                           VarParsing.VarParsing.multiplicity.singleton,
                           VarParsing.VarParsing.varType.bool,
                           'doSystematics'
                           )
...
customize.options.register('dumpTrees',
                           True, # JM set to True for ntupling
                           VarParsing.VarParsing.multiplicity.singleton,
                           VarParsing.VarParsing.varType.bool,
                           'dumpTrees'
                           )
...
# JM: add removal of tags for ntupling + relax selections for ttH Tags + add only one untag for remaining events
if customize.dumpTrees:
    ...
    process.flashggTTHHadronicTag.jetsNumberTTHHMVAThreshold = cms.int32(0)
    ...
    process.flashggTTHHadronicTag.secondMaxBTagTTHHMVAThreshold  = cms.double(-1000.0)
    process.flashggTTHHadronicTag.Boundaries         = cms.vdouble(-1.)
    process.flashggTTHHadronicTag.Boundaries_pt1     = cms.vdouble(-1.)
    process.flashggTTHHadronicTag.Boundaries_pt2     = cms.vdouble(-1.)
    process.flashggTTHHadronicTag.Boundaries_pt3     = cms.vdouble(-1.)
    process.flashggTTHHadronicTag.Boundaries_pt4     = cms.vdouble(-1.)
    process.flashggTTHHadronicTag.STXSPtBoundaries_pt1 = cms.vdouble(0,100000)
    process.flashggTTHHadronicTag.STXSPtBoundaries_pt2 = cms.vdouble(100000)
    process.flashggTTHHadronicTag.STXSPtBoundaries_pt3 = cms.vdouble(100001)
    process.flashggTTHHadronicTag.STXSPtBoundaries_pt4 = cms.vdouble(100002)
    process.flashggTTHHadronicTag.MuonPhotonDrCut = cms.double(-0)
    process.flashggTTHHadronicTag.ElePhotonDrCut = cms.double(-0)
    process.flashggTTHHadronicTag.DeltaRTrkEle = cms.double(-0)
    process.flashggTTHHadronicTag.debug = cms.bool(False)
    process.flashggTTHHadronicTag.applyMETfilters = cms.bool(False)
    process.flashggTTHLeptonicTag.MVAThreshold = cms.vdouble(-1.0)
    process.flashggTTHLeptonicTag.MVAThreshold_pt1 = cms.vdouble(-1.0)
    process.flashggTTHLeptonicTag.MVAThreshold_pt2 = cms.vdouble(-1.0)
    process.flashggTTHLeptonicTag.MVAThreshold_pt3 = cms.vdouble(-1.0)
    process.flashggTTHLeptonicTag.MVAThreshold_pt4 = cms.vdouble(-1.0)
    process.flashggTTHLeptonicTag.STXSPtBoundaries_pt1= cms.vdouble(0,100000)
    process.flashggTTHLeptonicTag.STXSPtBoundaries_pt2= cms.vdouble(100000)
    process.flashggTTHLeptonicTag.STXSPtBoundaries_pt3= cms.vdouble(100001)
    process.flashggTTHLeptonicTag.STXSPtBoundaries_pt4= cms.vdouble(100002)
    process.flashggTTHLeptonicTag.PhoMVAThreshold = cms.double(-0.9)
    ...
    process.flashggTTHLeptonicTag.MinNLep = cms.int32(1)
    process.flashggTTHLeptonicTag.MaxNLep = cms.int32(999)
    process.flashggTTHLeptonicTag.debug = cms.bool(False)
...
# JM for dumpTrees: set tag priorities
...
# JM: add variables to dump from cfg file
if customize.dumpTrees:
#    import flashgg.Taggers.dumpTreesVariables as var    
#    minimalVariables+= var.dipho_variables
#    minimalNonSignalVariables+= var.dipho_variables
    minimalVariables+= dipho_variables
    minimalNonSignalVariables+= dipho_variables
    minimalVariables+= weight_variables
    minimalNonSignalVariables+= weight_variables
...
# JM adapt tagList size
elif customize.dumpTrees:
     tagList=[
        ["UntaggedTag",0],
        ["TTHHadronicTag",0],
        ["TTHLeptonicTag",0]
